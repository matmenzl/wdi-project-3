...
SunApp.addInfoWindowForCity = function(city, marker){
  ...
  google.maps.event.addListener(marker, "click", function(){
    ...
    self.infowindow = new google.maps.InfoWindow({
      content: "<div id='snippet_searchpanel' style='width: auto; height:auto;'></div></br><div id='center-button'><button id='favourite-button' class='btn btn-primary'>favourite</button></div>"
    });
